    ...
    <div class="content" :style="{
        ...
        <div class="pageContent" :style="{
            ...
            <div v-if="!mobile" class="selectTimeBox" style="display:flex;flex-direction:column">
                <div style="display:flex;flex-direction: row;padding-left: 5vw;"><a
                        style="font-size:3vh;padding-left: 6vw;">起始时间:</a>
                ...
                <div style="display:flex;flex-direction: row;padding-left: 5vw;;padding-top: 4vh;"><a
                        style="font-size:3vh;padding-left: 6vw;">截止时间:</a>
                ...
                <el-button type="primary" style="width:16vw;height: 5vh;margin-top: 15vh;margin-left: 10vw;"
...
const submit = async () => {
    ...
    if (endTime.value <= startTime.value) {
        ...
        await service.post('/api/course/saveCourseSelectTime', { token: localStorage.getItem('token'), startTime: startTime.value, endTime: endTime.value }).then(res => {
            let data = res.data;
            if (data.success) {
                hideLoading();
