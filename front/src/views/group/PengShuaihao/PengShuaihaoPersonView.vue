  ...
  <div class="container">
    <div class="header" v-if="!isSelf">
      <div class="titleBox">
        ...
        <img class="englishImg" v-if="!mobile"
          src='https://courseback.clankalliance.cn/static/inbuild/psh/烟火一格英语.png' />
        <img class="chineseImg" style="width:60%" v-if="mobile"
          src='https://courseback.clankalliance.cn/static/inbuild/psh/烟火一格.png' />
        <img class="englishImg" style="width:60%" v-if="mobile"
          src='https://courseback.clankalliance.cn/static/inbuild/psh/烟火一格英语.png' />
      </div>
      <div class="imgBox">
      </div>
    </div>
    <div class="menuBox" v-if="!isSelf">
      <el-menu class="menu" default-active="/PengShuaihao" mode="horizontal" background-color="#545c64"
    ...
    <div class="main" v-if="!isSelf"
      :style="{ 'padding-left': `${mobile ? '0' : '10vw'}`, 'padding-right': `${mobile ? '0' : '10vw'}` }">
      <div class="carouselBox" :style="{
        'height': `${mobile ? '50vh' : '70vh'}`,
        'width': `${mobile ? '100vw' : '100%'}`,
      }" v-if="!isMenu">
        <el-carousel ref="carousel" v-touch:swipe.left="right" v-touch:swipe.right="left" class="carouselPage"
          height="100%" interval="4000">
          <el-carousel-item class="carouselItem">
            <img style="width: 100%; height: 100%"
              src='https://courseback.clankalliance.cn/static/inbuild/psh/横屏3.jpg' />
          </el-carousel-item>
          <el-carousel-item class="carouselItem">
            <img style="width: 100%; height: 100%"
              src='https://courseback.clankalliance.cn/static/inbuild/psh/横屏2.jpg' />
          </el-carousel-item>
          <el-carousel-item class="carouselItem">
            <img style="width: 100%; height: 100%"
              src='https://courseback.clankalliance.cn/static/inbuild/psh/雪景.jpg' />
          </el-carousel-item>
        </el-carousel>
      </div>
      ...
      <div class="carouselBox" v-if="isMenu">
        <img v-if="attractions == 'Baotu'" style="width:100%;height: 100%;"
          src="https://courseback.clankalliance.cn/static/inbuild/psh/趵突泉.jpg" />
        <img v-if="attractions == 'lake'" style="width:100%;height: 100%;"
          src="https://courseback.clankalliance.cn/static/inbuild/psh/大明湖.png" />
        <img v-if="attractions == 'leave'" style="width:100%;height: 100%;"
          src="https://courseback.clankalliance.cn/static/inbuild/psh/红叶谷.jpeg" />
        <img v-if="attractions == 'house'" style="width:100%;height: 100%;"
          src="https://courseback.clankalliance.cn/static/inbuild/psh/洪家楼.jpg" />
      </div>
      ...
      <div class="contentAttraction" v-if="isMenu">
        ...
        <el-scrollbar class="attractionScrollbar">
          ...
          <div style="padding-right:6vw;padding-left:3vw;" v-if="attractions == 'Baotu'"><a class="attrIntro">{{
            Baotu
          }}</a></div>
          <div style="padding-right:6vw;padding-left:3vw;" v-if="attractions == 'lake'"><a class="attrIntro">{{
            lake
          }}</a></div>
          <div style="padding-right:6vw;padding-left:3vw;" v-if="attractions == 'house'"><a class="attrIntro">{{
            house
          }}</a></div>
          <div style="padding-right:6vw;padding-left:3vw;" v-if="attractions == 'leave'"><a class="attrIntro">{{
            leave
          }}</a></div>
          <el-divider />
          <!-- <span class="attractionTitle"><a>详情</a> </span> -->
          <el-descriptions v-if="attractions == 'Baotu'" class="margin-top" :column="2" title="详情" border>
          ...
          <el-descriptions v-if="attractions == 'lake'" class="margin-top" :column="2" title="详情" border>
            <el-descriptions-item>
              <template #label>
                <div class="cell-item">
                  <el-icon>
          ...
          <el-descriptions v-if="attractions == 'house'" class="margin-top" :column="2" title="详情" border>
            <el-descriptions-item>
              <template #label>
                <div class="cell-item">
                  <el-icon>
          ...
          <el-descriptions v-if="attractions == 'leave'" class="margin-top" :column="2" title="详情" border>
            <el-descriptions-item>
              <template #label>
                <div class="cell-item">
                  <el-icon>
      ...
      <div class="introductionBox" v-if="!isSelf">
    ...
    <div class="footer" v-if="(isMenu || !mobile)&&!isSelf">
      <h3 class="copyright">@版权所有:彭帅豪</h3>
    </div>
  </div>
</template>
...
const checkInfo = () => {
  ...
  isMenu.value = true;
  attractions.value = '';
  router.push('/PengShuaihao/SelfInfo');
}
const toMainPage = () =>{
  isMenu.value = false;
  isSelf.value = false;
